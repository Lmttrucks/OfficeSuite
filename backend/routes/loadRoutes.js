...
const { searchLoadsByCompanyAndDate, getLoads, addLoad, getLast1000Loads, updateLoadById, deleteLoadById, updateOutgoingInvoiceNo, getAllNonArchivedLoads, clearOutgoingInvoiceNo, addLinkLoad, updateLinkLoadInvoiceNo, getExternalLoads } = require('../controllers/loadController');
