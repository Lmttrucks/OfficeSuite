...
const { searchLoadsByCompanyAndDate, getLoads, addLoad, getLast100Loads, updateLoadById, deleteLoadById, updateOutgoingInvoiceNo } = require('../controllers/loadController');
