...
const { searchLoadsByCompanyAndDate, getLoads, addLoad, getLast100Loads, updateLoadById, deleteLoadById, updateOutgoingInvoiceNo, getAllNonArchivedLoads, clearOutgoingInvoiceNo, addLinkLoad, updateLinkLoad, getExternalLoads } = require('../controllers/loadController');
...
router.put('/update-link-load/:loadID', authenticateToken, authorizeRoles(['admin']), updateLinkLoad);
